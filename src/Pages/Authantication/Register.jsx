...
logout_at : new Date().toISOString()
      ...
      const useRes= await axiosInstance.post('/user', userInfo);
      console.log('User created:', useRes.data);
        ...
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            {errors.name?.type === 'required' && (
              <p className="text-red-500">Required Name</p>
            )}
          </div>
          ...
          <div>
            <label htmlFor="profileImage" className="block mb-1 text-sm">
              Profile Image
            </label>
            <input
              type="file"
